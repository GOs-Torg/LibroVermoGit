...
public class Review {
    ...
    public String getReview_Client() {
        return id_Client;
    }

    public void setReview_Client(String review_Client) {
        this.id_Client = review_Client;
    }

    public String getReview_Employee() {
        return id_Employee;
    }

    public void setReview_Employee(String review_Employee) {
        this.id_Employee = review_Employee;
    }
